// Add an entry here whenever a new page or resource link goes up.
var SEARCH_INDEX = [
  // Pages
  ...
  { label: 'Resources', url: 'resources.html', context: 'Page', external: false },

  // Tools
  { label: 'Live Coach Tool', url: 'https://prismscoach.github.io/PrismsEmailGenerator/live-coach-tool.html', context: 'Coaching · Tool', external: true },
  ...
  { label: 'Facilitator Guide', url: 'teacher-institute.html', context: 'Teacher Institute', external: false },
  { label: 'Participant Materials', url: 'teacher-institute.html', context: 'Teacher Institute', external: false },
  { label: 'Survey Questions', url: 'teacher-institute.html', context: 'Teacher Institute', external: false },
  { label: 'Unit Planning Resources', url: 'teacher-institute.html', context: 'Teacher Institute', external: false },
  { label: 'Teacher Institute Guide', url: 'teacher-institute.html', context: 'Teacher Institute', external: false },

  // Coaching resources
  { label: 'Prisms Coach Guide', url: 'coaching.html', context: 'Coaching', external: false },
